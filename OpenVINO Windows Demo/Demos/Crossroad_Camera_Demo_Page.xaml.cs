...
namespace OpenVINO_Windows_Demo.Demos
{
    ...
    public sealed partial class Crossroad_Camera_Demo_Page : Page
    {
        ...
        List<string> filter_model0 = new List<string> { "person-vehicle-bike-detection" };
        ...
        List<string> filter_model1 = new List<string> { "person-attributes-recognition" };
        List<string> filter_filter_model1 = new List<string> { /*"face-detection-0105", "face-detection-0106"*/ };
        const string model1_arg_parse = "_pa";
        List<Combobox_models> combobox2_Models = new List<Combobox_models>();
        List<string> filter_model2 = new List<string> { "person-reidentification" };
        ...
        const string connector_commandstr = "Crossroad_Camera_Demo_Page";
